...
## VSCode＋GitHub Copilot を使う目的

- 生産性を向上し、成果を最大化する
- コードやアウトプットの質を高める
- 空いた時間でさらに学び・成長できる
- とにかくAIに興味があってこの流行りに乗りたい
- みんなでより良い開発体験を！
...
- まずは気軽に使ってみて、みんなで最高の開発体験をシェアしよう！

---

## 告知・宣伝

まもなく開発本部でGitHub Copilotライセンスを付与します。新たにCopilot利用ポリシーも策定したので、説明会を開催予定です。
ガイドラインはこれからみんなで作り上げていきたいと考えています。

**特にお願いしたいこと**

- 旧AI研究会メンバーやCopilot検証担当だった方はご協力を！
